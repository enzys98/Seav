...
let method = "GET";
let url = "/assets/UtilityPHP/utilityimpiantiStabilimenti.php";
    ...
    if (this.readyState == 4 && this.status == 200) {
        ...
        data.forEach(element => {
            if(element.includes('.jpg') || element.includes('.jpeg') || element.includes('.png') || element.includes('.JPG')) {
                ...
                a.href = "/assets/img/impiantiStabilimenti/" +element;
                a.setAttribute("data-fancybox","gallery1");
                let img = document.createElement('img');
                img.setAttribute("width","100%");
                img.setAttribute("height","100%");
                img.src = "../assets/img/impiantiStabilimenti/" +element;
                a.appendChild(img);
